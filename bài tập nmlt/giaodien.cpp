...
public:
    ...
    void deleteMenu(); //Xóa menu khi k?t thúc ch??ng trình b?ng cách vi?t ?è kí t? tr?ng
...
private:
    ...
    string* item; //M?ng l?u tên c?a các menu
...
void Menu::deleteMenu() {
    ...
    for (int i = 0; i < _numberOfItem; i++) {
        ...
        for (int j = 0; j < item[i].size() + 3; j++) {
            ...
            cout << " "; //Xóa b?ng cách ghi ?è kí t? tr?ng
